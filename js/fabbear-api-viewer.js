...
APIClient.prototype = {
    ...
    use: function(version, callback) {
        ...
        if (this._ready) callInitAPI();
        else this.initAPI = callInitAPI;
    },
...
Sketchfab.prototype = {
    getEmbedURL: function(urlid, options) {
        var url =
            this._url + '?api_version=' + this._version + '&api_id=' + this._client.getIdentifier();
...
//# sourceMappingURL=sketchfab-viewer-1.0.2.js.map